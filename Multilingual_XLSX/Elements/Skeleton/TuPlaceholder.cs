...
{
    public class TuPlaceholder : StructuralElement
    {
        ...
        public TuPlaceholder()
        {

        }

        public TuPlaceholder(XmlNode xmlNode) : base(xmlNode)
        {
            if (!sName.Equals("tu-placeholder"))
            {
                throw new Exception(String.Format("XmlNode name is different than tu-placeholder."));
            }
        }
